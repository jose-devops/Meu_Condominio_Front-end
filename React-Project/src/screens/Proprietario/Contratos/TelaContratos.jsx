...
import CampoBuscaContratos from '../../Components/Contratos/CampoBuscaContratos';
...
export default function TelaContrato({ token }) {  
...
useEffect(() => {
  ...
  return (
    <div className={`contrato-container ${sidebarRetracted ? 'sidebar-collapsed' : ''}`}>
      <MenuLateral isCollapsed={sidebarRetracted} toggleSidebar={toggleSidebar} />
      <div className="conteudo-principal-contrato">

        <header className="header-contratos">
          <div className='title-header-contratos'>
        ...
        <main className="area-contratos">


          <div className="controlesTable-container">

            <div className="buscaContrato-container">
              <CampoBuscaContratos 
            ...
            <div className="botoes-container-contrato">
              <button className="botao-atualizar-contratos" onClick={atualizarDados} title="Atualizar">
          ...
          <div className='Area-Tabela-Contratos'>
            <TabelaContratos
